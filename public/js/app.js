...
(function () {
  (0,_modal__WEBPACK_IMPORTED_MODULE_1__.updateUser)();
  (0,_modal__WEBPACK_IMPORTED_MODULE_1__.destroyUser)();
...
/* harmony export */ });
function updateUser() {
  var updateUserodalTriggers = document.querySelectorAll('[data-modal-toggle="updateUserModal"]');
  var updateUserModal = document.querySelector("#updateUserModal");
  var idInput = updateUserModal.querySelector("#id");
  var nameInput = updateUserModal.querySelector("#name");
  var emailInput = updateUserModal.querySelector("#email");
  updateUserodalTriggers.forEach(function (trigger) {
...
function destroyUser() {
  var deleteUserModalTriggers = document.querySelectorAll('[data-modal-toggle="deleteModal"]');
  var deleteUserModal = document.querySelector("#deleteModal");
  var idInput = deleteUserModal.querySelector("#id");
  deleteUserModalTriggers.forEach(function (trigger) {
    trigger.addEventListener("click", function () {
      var id = trigger.getAttribute("data-id");
      idInput.value = id;
    });
